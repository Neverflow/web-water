<template>
    <el-row id="now_ph">
        ...
        <el-row :gutter="40">
            <el-col :md="12">
                <el-card class="chart-container" id="nowph1">Echarts1</el-card>
            </el-col>
            <el-col :md="12">
...
export default {
    ...
    methods: {
        async initValue() {
            ...
            const res = await reqWater({ nowph: true });
            // 时间过滤器处理ISO格式
        ...
        drawChart() {
            ...
            let myChart = this.$echarts.init(document.getElementById("nowph1"));
            // 指定图表的配置项和数据
            let option = {
                title: {
                    text: "当前PH测量值",
